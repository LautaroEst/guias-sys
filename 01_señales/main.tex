...
\begin{ejercicio}
    ...
    \begin{align*}
        \inciso \parbox{.3\textwidth}{\input{01_señales/plots/1-demo_signal}} & \hfill & \inciso \parbox{.3\textwidth}{\input{01_señales/plots/1-demo_signal2}}    
    \end{align*}
...
\begin{ejercicio}
    ...
    \begin{align*}
    \inciso \parbox{.3\textwidth}{\input{01_señales/plots/1-odd_even}} & \hfill & \inciso \parbox{.3\textwidth}{\input{01_señales/plots/1-odd_even2}}
    \end{align*}
\end{ejercicio}
