...
\begin{ejercicio}
    ...
    \begin{align*}
        ...
        \begin{cases} 
            ...
            0 & \mbox{en otro caso}
        \end{cases} & \hspace{\fill} 
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-1d}} \\
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-1e}} & \hspace{\fill} 
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-1f}} \\
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-1g}} & \hspace{\fill} & \\
    \end{align*}
    \end{ejercicio}
    ...
    \begin{center}
        \input{04_transformada_fourier/plots/4-2}
    \end{center}
    ...
    \begin{center}
        \input{04_transformada_fourier/plots/4-4}
    \end{center}
...
\begin{ejercicio}
    ...
    \begin{align*}
        \inciso & \parbox{.5\textwidth}{\input{04_transformada_fourier/plots/4-6a}} & \hspace{\fill} &
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-6b}} \\
        \inciso & \parbox{.5\textwidth}{\input{04_transformada_fourier/plots/4-6c}} & \hspace{\fill} &
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-6d}} \\
        \inciso & \parbox{.5\textwidth}{\input{04_transformada_fourier/plots/4-6e}} & \hspace{\fill} &
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-6f}} \\
    \end{align*}
...
\begin{ejercicio}
    ...
    \begin{center}
    \parbox{.7\textwidth}{\input{04_transformada_fourier/plots/4-10}}
    \end{center}
...
\begin{ejercicio}
    Para cada una de las siguientes funciones
    \begin{align*}
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-11a}} &
        \inciso & \parbox{.4\textwidth}{\input{04_transformada_fourier/plots/4-11b}} \\
        \inciso & \parbox{.3\textwidth}{\input{04_transformada_fourier/plots/4-11c}} &
        \inciso & \parbox{.4\textwidth}{\input{04_transformada_fourier/plots/4-11d}} 
    \end{align*}
    indicar si cumplen algunas de estas condiciones:
    \begin{align*}
...
\begin{ejercicio}
    ...
    \begin{center}
    \parbox{.7\textwidth}{\input{04_transformada_fourier/plots/4-pbandas_modulador.tex}}
    \end{center}
...
\begin{ejercicio}
    ...
    \begin{center}
    \parbox{.7\textwidth}{\input{04_transformada_fourier/plots/4-pbandas_modulador2.tex}}
    \end{center}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \begin{center}
        \parbox{.7\textwidth}{\input{04_transformada_fourier/plots/4-modulador3}}
    \end{center}
    donde
    \begin{align*}
        \parbox{.4\textwidth}{\input{04_transformada_fourier/plots/4-modulador3_input}} &
        \parbox{.4\textwidth}{\input{04_transformada_fourier/plots/4-modulador3_pb}}
    \end{align*}
