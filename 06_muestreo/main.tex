...
\begin{ejercicio}
    ...
    \begin{center}
    \input{06_muestreo/plots/5-cos_input}
    \end{center}
...
\begin{ejercicio}
    ...
    \begin{center}
    \input{06_muestreo/plots/5-2bis}
    \end{center}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \begin{center}
        \input{06_muestreo/plots/5-hc_ad_h}
    \end{center}
...
\begin{ejercicio}
    Sea el siguiente sistema:
    \begin{center}
        \input{06_muestreo/plots/5-hc_ad_h_da}
    \end{center}
...
%     \begin{center}
%         \input{06_muestreo/plots/5-up_down_eq}
%     \end{center}
...
\begin{ejercicio}
    ...
    \begin{center}
        \input{06_muestreo/plots/5-up2_down2}
    \end{center}
...
\begin{ejercicio}
    ...
    \begin{center}
        \input{06_muestreo/plots/5-pulse_g}
    \end{center}
...
\begin{ejercicio}
    Sea el siguiente sistema:
    \begin{center}
        \input{06_muestreo/plots/5-ad_up_h_down_da}
    \end{center}
    donde 
    \begin{align*}
        \parbox{0.5\textwidth}{
                \input{06_muestreo/plots/5-r_c}
...
\begin{ejercicio}
    ...
    \begin{center}
        \input{06_muestreo/plots/5-ad_up_h_mult_da}
    \end{center}
    ...
    \begin{align*}
        \parbox{0.5\textwidth}{
            \begin{center}
                \input{06_muestreo/plots/5-ad_up_h_mult_da_x}
            \end{center}
        } & \hspace*{1em} & \parbox{0.5\textwidth}{
            \begin{center}
                \input{06_muestreo/plots/5-ad_up_h_mult_da_h}
            \end{center}
        }
    \end{align*}        
